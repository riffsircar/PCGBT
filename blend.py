...
def upward_section(game):
	...
	ul = UpLeftSegment('UL',game)
	bbl.num_nodes = random.randint(2,4)
	ud = UpwardSegment('UD',game)
	dr = DownRightSegment('DR',game)
	root.add_child(ul)
	root.add_child(ud)
	root.add_child(dr)
	return root
...
def downward_section(game):
	...
	dl = DownLeftSegment('DL',game)
	bbl.num_nodes = random.randint(2,4)
	ud = DownwardSegment('UD',game)
	ur = UpRightSegment('UR',game)
	root.add_child(dl)
	root.add_child(ud)
	root.add_child(ur)
	return root
